...
public class InventoryRepository {
	...
	public void addPart(Part part){
		if(part.getInStock()<0)
			throw new IllegalArgumentException("Part must have at least 0 in stock");
		if(part.getInStock()< part.getMin())
			throw new IllegalArgumentException("Part must have at least the minimum stock");
		if(part.getInStock()> part.getMax())
			throw new IllegalArgumentException("Inventory level is higher than the maximum value.");
		if(part.getPrice()<0)
	...
	public void addProduct(Product product){
		if(product.getInStock()<0)
			throw new IllegalArgumentException("Product must have at least 0 in stock");
