...
setInterval(() => {
  lastUpdated = new Date();
  let id = randomInt(500);
  while (notes.find(nota => nota.id == id)) id = randomInt(500);
  const note = {
    id,
    text: `Note ${id}`,
    date: lastUpdated
...
module.exports = __webpack_require__(/*! C:\Users\Paula\Downloads\note\note\server\src/index.js */"./src/index.js");
