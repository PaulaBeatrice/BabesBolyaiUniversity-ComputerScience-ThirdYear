...
public class Atom {
    ...
    private String text;
    private final String ID = "^[a-zA-Z_][a-zA-Z0-9_]{0,}$"; // incepe cu o litera sau "_" si poate contine litere, cifre sau caractere de subliniere in continuare
    ...
    private final String[] CUVINTE_CHEIE = {"#include", "<iostream>", "<cmath>", "<cstring>", "using", "namespace", "std", "int", "main", "int", "double", "struct", "cin", "cout", "if", "else", "while"};
