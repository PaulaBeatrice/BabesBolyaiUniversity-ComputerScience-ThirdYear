...
#include <queue>
#include <vector>
#include "../../Tema2_C++/Tema2_C++/MyBarrier.h"
...
int main() {
    //std::vector<std::vector<int>> A_secv(N + 2, std::vector<int>(N + 2));
    //std::vector<std::vector<int>> A_paralel(N + 2, std::vector<int>(N + 2));
    //std::vector<std::vector<int>> K(3, std::vector<int>(3));
   ...
   for (int i = 0; i < N + 2; ++i) {
    ...
    //int lines[3 * N][M + 2];
    std::vector<std::vector<int>> lines(3*N, std::vector<int>(M+2));
